...
const startIntervals = () => {
    setInterval(() => {
        ...
        if(!data.prices.hours[data.prices.hours.length - 1] || data.prices.hours[data.prices.hours.length - 1].hour != hour){
            data.prices.hours.push({hour: hour, price: value});
        }
        if(!data.prices.days[data.prices.days.length - 1] || data.prices.days[data.prices.days.length - 1].day != day){
            let price = 0;
            let sum = 0;
        ...
        if(!data.prices.weeks[data.prices.weeks.length - 1] || data.prices.weeks[data.prices.weeks.length - 1].week != week){
            price = 0;
            sum = 0;
        ...
        if(!data.prices.months[data.prices.months.length - 1] || data.prices.months[data.prices.months.length - 1].month != month){
            price = 0;
            sum = 0;
        ...
        if(!data.prices.years[data.prices.years.length - 1] || data.prices.years[data.prices.years.length - 1].year != year ){
            price = 0;
            sum = 0;
